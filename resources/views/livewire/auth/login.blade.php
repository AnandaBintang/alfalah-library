  ...
  <div class="max-w-md w-full bg-white p-8 rounded shadow">
    ...
    <form wire:submit.prevent="login" class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <div>
          <p><a
              class="text-blue-600 underline underline-offset-1 decoration-blue-600 hover:opacity-80 focus:outline-hidden focus:opacity-80"
              href="{{ route('password.request') }}" wire:navigate>Forget password</a></p>
        </div>
      </div>
