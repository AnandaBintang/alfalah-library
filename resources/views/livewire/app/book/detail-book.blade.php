<div class="mx-auto mb-19 w-10/12">
  <div class="flex flex-col md:flex-row gap-6">
    ...
    <div class="flex-shrink-0 w-full md:w-1/3">
      <img
        src="{{ asset('storage/' . $data->cover_image_path) }}"
        alt="{{ $data->title }}"
      ...
      <div class="space-y-2 text-gray-700">
        ...
        <p>
          ...
          @forelse ($data->categories as $category)
            <span
              class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-600 text-white dark:bg-blue-500">{{ $category->name }}</span>
          @empty
